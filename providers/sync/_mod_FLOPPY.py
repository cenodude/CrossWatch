...
def get_manifest() -> Mapping[str, Any]:
    return {
        ...
        "capabilities": {
            ...
            "history": {"read": True, "write": True, "types": {"movies": True, "shows": False, "seasons": False, "episodes": True}, "upsert": True, "remove": True, "remove_watched_status": False, "observed_deletes": True, "requires_ids": ["tmdb"], "event_history": True, "rewatches": {"read": True, "write": True, "account_gate": False}},
