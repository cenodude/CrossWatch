    ...
    <div id="about-host" role="dialog" aria-label="About CrossWatch">
      ...
      <div class="body">
        ...
        <section class="card">
          ...
          <div class="discBody">
            <div>CrossWatch is an independent community project. It is not affiliated with, endorsed by, or sponsored by Plex, Jellyfin, Emby, Kodi, Nuvio, Stremio, MDBList, AniList, Floppy, PunchPlay, BingeBase, FlickList, Scrob, TMDb, SIMKL, PublicMetaDB, Trakt, Tautulli, or their owners. CrossWatch uses the AniBridge mappings dataset and the animeApi dataset for anime identifier and episode translation.</div>
            <ul>
