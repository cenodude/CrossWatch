...
html[data-cw-theme="flat-dark"] .cw-insight-set .panel::before,html[data-cw-theme="flat-dark"] .cw-insight-set .prov-card::before{content:none!important}
...
html[data-cw-theme="flat-light"] .cw-insight-set .panel::before,html[data-cw-theme="flat-light"] .cw-insight-set .prov-card::before{content:none!important}
...
const injectCSS = () => {
  if (!$("#cw-insight-set-css")) {
    const el = document.createElement("style");
    el.id = "cw-insight-set-css";
    el.textContent = STYLE;
    document.head.appendChild(el);
  }
  if (!$("#cw-insight-set-theme-css")) {
    const el = document.createElement("style");
    el.id = "cw-insight-set-theme-css";
