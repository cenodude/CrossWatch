...
export default {
  async mount(root){
    ...
    const refreshCounts=()=>{const sel=state.mode==="all"?state.total:state.selected.size; countEl.textContent=`Selected: ${sel} of ${state.total}`};
