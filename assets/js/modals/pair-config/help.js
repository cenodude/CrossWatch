...
export const HELP_TEXT = {
  ...
  "cx-hs-anime-map": "Anime episode mapping\nTranslate anime episode numbering for this history pair using the local AniBridge dataset. Requires a TMDB metadata key. When enabled from here, global Anime ID Mapping is enabled too.",
