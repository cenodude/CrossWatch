(function (w, d) {
  ...
  const PROV={PLEX:{cls:"cf-plex",logo:"/assets/img/PLEX-log.svg"},SIMKL:{cls:"cf-simkl",logo:"/assets/img/SIMKL-log.svg"},ANILIST:{cls:"cf-anilist",logo:"/assets/img/ANILIST-log.svg"},CROSSWATCH:{cls:"cf-crosswatch",logo:"/assets/img/CROSSWATCH-log.svg"},TRAKT:{cls:"cf-trakt",logo:"/assets/img/TRAKT-log.svg"},JELLYFIN:{cls:"cf-jellyfin",logo:"/assets/img/JELLYFIN-log.svg"},MDBLIST:{cls:"cf-mdblist",logo:"/assets/img/MDBLIST-log.svg"},TAUTULLI:{cls:"cf-tautulli",logo:"/assets/img/TAUTULLI-log.svg"}};
