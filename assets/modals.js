...
function _provIconPath(name){const key=String(name||"").trim().toUpperCase(),map={PLEX:"PLEX",JELLYFIN:"JELLYFIN",SIMKL:"SIMKL",TRAKT:"TRAKT"},file=map[key]||key;return `/assets/img/${file}.svg`}
