...
(function(){
  const providers = Object.freeze({
    ...
    PLEX: { key: "PLEX", label: "Plex", shortLabel: "Plex", brandClass: "brand-plex", badgeId: "badge-plex", authSectionId: "sec-plex", authGroupId: "sec-auth-media", aliases: ["PLEX"], statusLegacy: ["plex_connected", "plex"], hasLogo: true, hasLogLogo: true, tone: { solid: "#e5a000", rgb: "229,160,0" }, watchlist: true, collection: true },
    ...
    JELLYFIN: { key: "JELLYFIN", label: "Jellyfin", shortLabel: "Jellyfin", brandClass: "brand-jellyfin", badgeId: "badge-jellyfin", authSectionId: "sec-jellyfin", authGroupId: "sec-auth-media", aliases: ["JELLYFIN"], statusLegacy: ["jellyfin_connected", "jellyfin"], hasLogo: true, hasLogLogo: true, tone: { solid: "#7b61ff", rgb: "123,97,255" }, watchlist: true, collection: true },
    EMBY: { key: "EMBY", label: "Emby", shortLabel: "Emby", brandClass: "brand-emby", badgeId: "badge-emby", authSectionId: "sec-emby", authGroupId: "sec-auth-media", aliases: ["EMBY"], statusLegacy: ["emby_connected", "emby"], hasLogo: true, hasLogLogo: true, tone: { solid: "#3bb273", rgb: "59,178,115" }, watchlist: true, collection: true },
