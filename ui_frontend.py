  ...
  <section id="ops-card" class="card cw-main-card cw-main-card--sync">
    ...
    <div class="action-row">
      <div class="action-buttons">
        ...
        <button id="run-cancel" class="btn cw-hub-action cw-run-cancel hidden" type="button" onclick="cancelSync()" title="Stop the running sync" aria-label="Stop the running sync"><span class="material-symbols-rounded cw-action-icon" aria-hidden="true">stop_circle</span><span class="label">Cancel</span></button>
